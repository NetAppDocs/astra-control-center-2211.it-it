...
Centro di controllo Astra supporta cluster Kubernetes con classe di storage basata su Trident con un backend di storage ONTAP 9.5 e versioni successive.
